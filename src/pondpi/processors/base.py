class LevelProcessor:
    ...
    return this processor's current output. `extra_state()` surfaces any
    processor-specific metadata (window sizes, sample counts, ...) for
    the /level response. Processors are unit-agnostic — they don't know
